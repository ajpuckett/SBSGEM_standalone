...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           TrackNhits;
   Int_t           Nlayers;
   Int_t           Ncluster[10];   //[Nlayers]
   Int_t           HitModule[10];   //[TrackNhits]
   Int_t           HitLayer[10];   //[TrackNhits]
   Double_t        HitXlocal[10];   //[TrackNhits]
   Double_t        HitYlocal[10];   //[TrackNhits]
   Double_t        HitXglobal[10];   //[TrackNhits]
   Double_t        HitYglobal[10];   //[TrackNhits]
   Double_t        HitZglobal[10];   //[TrackNhits]
   Double_t        HitXresid[10];   //[TrackNhits]
   Double_t        HitYresid[10];   //[TrackNhits]
   Double_t        HitXresidE[10];   //[TrackNhits]
   Double_t        HitYresidE[10];   //[TrackNhits]
   Double_t        HitSigX[10];   //[TrackNhits]
   Double_t        HitSigY[10];   //[TrackNhits]
   Double_t        HitXmom[10];   //[TrackNhits]
   Double_t        HitYmom[10];   //[TrackNhits]
   Double_t        HitADCX[10];   //[TrackNhits]
   Double_t        HitADCY[10];   //[TrackNhits]
   Double_t        HitADCasym[10];   //[TrackNhits]
   Double_t        HitTmean[10];   //[TrackNhits]
   Double_t        HitdT[10];   //[TrackNhits]
   Double_t        HitCorrCoeff[10];   //[TrackNhits]
   Double_t        StripMaxCorrCoeff[10];   //[TrackNhits]
   Int_t           HitNstripX[10];   //[TrackNhits]
   Int_t           HitNstripY[10];   //[TrackNhits]
   Int_t           HitXstripMax[10];   //[TrackNhits]
   Int_t           HitYstripMax[10];   //[TrackNhits]
   Int_t           HitXstripLo[10];   //[TrackNhits]
   Int_t           HitYstripLo[10];   //[TrackNhits]
   Int_t           HitXstripHi[10];   //[TrackNhits]
   Int_t           HitYstripHi[10];   //[TrackNhits]
